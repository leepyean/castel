...
function preload()
{
	...
	//loading animations
	char = loadAnimation("mar2.png","mar3.png")

	//loading other image
	control1Img =loadImage("control.png");
	control2Img =loadImage("control2.png");
	controlUpImg =loadImage("conup.png");
	castleImg =loadImage("castle.png");
	cloudImg =loadImage("cloud.png");
	enemyImg=loadImage("enemy.png");
	coinI=loadImage("money.png");
	mainenI=loadImage("mainboss.png");
	lifeI=loadImage("heart.png");
